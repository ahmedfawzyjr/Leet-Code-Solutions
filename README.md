...
graph TD
    ...
    Root --> P1["1. Two Sum"]
    Root --> P2["2. Add Two Numbers"]
    Root --> P3["3. Longest Substring Without Repeating Characters"]
    Root --> P4["4. Median of Two Sorted Arrays"]
    Root --> P5["5. Longest Palindromic Substring"]
    Root --> P6["6. Zigzag Conversion"]
    Root --> P7["7. Reverse Integer"]
    Root --> P8["8. String to Integer (atoi)"]
    Root --> P9["9. Palindrome Number"]
    Root --> P10["10. Regular Expression Matching"]
    Root --> P11["11. Container With Most Water"]
    Root --> P12["12. Integer to Roman"]
    Root --> P13["13. Roman to Integer"]
    Root --> P14["14. Longest Common Prefix"]
    Root --> P15["15. 3Sum"]
    Root --> P16["16. 3Sum Closest"]
    Root --> P17["17. Letter Combinations of a Phone Number"]
    Root --> P18["18. 4Sum"]
    Root --> P19["19. Remove Nth Node From End of List"]
    Root --> P20["20. Valid Parentheses"]
    Root --> P21["21. Merge Two Sorted Lists"]
    Root --> P22["22. Generate Parentheses"]
    Root --> P23["23. Merge k Sorted Lists"]
    Root --> P24["24. Swap Nodes in Pairs"]
    Root --> P25["25. Reverse Nodes in k-Group"]
    Root --> P26["26. Remove Duplicates from Sorted Array"]
    Root --> P27["27. Remove Element"]
    Root --> P28["28. Find the Index of the First Occurrence in a String"]
    Root --> P29["29. Divide Two Integers"]
    Root --> P30["30. Substring with Concatenation of All Words"]
    Root --> P31["31. Next Permutation"]
    Root --> P32["32. Longest Valid Parentheses"]
    Root --> P33["33. Search in Rotated Sorted Array"]
    Root --> P34["34. Find First and Last Position of Element in Sorted Array"]
    Root --> P35["35. Search Insert Position"]
    Root --> P36["36. Valid Sudoku"]
    Root --> P37["37. Sudoku Solver"]
    Root --> P38["38. Count and Say"]
    Root --> P39["39. Combination Sum"]
    Root --> P40["40. Combination Sum II"]
    Root --> P41["41. First Missing Positive"]
    Root --> P42["42. Trapping Rain Water"]
    Root --> P43["43. Multiply Strings"]
    Root --> P44["44. Wildcard Matching"]
    Root --> P45["45. Jump Game II"]
    Root --> P46["46. Permutations"]
    Root --> P47["47. Permutations II"]
